...
$(bin)\compilier.exe : $(bin)\parser.o $(bin)\tree.o $(bin)\compiling.o $(src)\main.cpp
	$(GPP) $(src)\main.cpp $(bin)\parser.o $(bin)\tree.o $(bin)\compiling.o -o $(bin)\compilier.exe $(options)
